...
export default function SettingsScreen() {
  ...
  const platformLinks = platformsResp?.platformLinks || [];

  const handleUnlink = (linkId: string, platformName: string) => {
    Alert.alert(
      "Unlink Platform",
      `Are you sure you want to unlink ${platformName}?`,
      [
        ...
        { 
          ...
          onPress: async () => {
            try {
              await unlinkPlatform(linkId).unwrap();
            } catch (err) {
              Alert.alert("Error", "Failed to unlink platform");
            }
          }
        }
      ]
    ...
    <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
      ...
      >
        ...
        <View style={styles.sectionHeader}>
          <AppText style={styles.sectionTitle}>Connected Platforms</AppText>
        </View>
